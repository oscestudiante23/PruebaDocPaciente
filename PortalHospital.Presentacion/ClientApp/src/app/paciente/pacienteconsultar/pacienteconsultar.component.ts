...
@Component({
  selector: 'app-pacienteconsultar',
  templateUrl: './pacienteconsultar.component.html',
  styleUrls: ['./pacienteconsultar.component.css']
})

export class PacienteconsultarComponent implements OnInit {
  ...
  public DetallePacienteClick(id: string) {
    ...
    this.toastr.clear();
    if (id)
      this.router.navigate(['pacienteconsultardet/', id]);
  }
}
